...
Example 1: ./trigger_tool_install.sh bowtie
The above command tells the trigger script to install the current version of bowtie

Example 2: ./trigger_tool_install.sh bowtie v1.2.1.0
The above command tells the trigger script to install version v1.2.1.0
```
