...
This sub-directory contains:
 - [The Package Config File](#the-package-config-file)(cufflinks_package.cfg)
 - [The Package Dependencies File](#the-package-dependencies-file)(cufflinks_dependencies.cfg)

Cufflinks is one of the tools we do not intall from source,instead we download binaries from the download site.
